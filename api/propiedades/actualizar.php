...
// Funciones auxiliares copiadas de guardar.php
...
// Manejo principal de la actualización
try {
    ...
    $required_fields = ['id', 'operacion', 'tipo_inmueble', 'variante', 'direccion', 'estado', 'ciudad', 'usuario_id'];
    ...
    try {
        ...
        $query = "UPDATE properties SET 
            ...
            property_variant_id = :property_variant_id,
            address = :address,
            state_id = :state_id,
            city_id = :city_id,
            colony_id = :colony_id,
        ...
        $stmt->bindParam(":updated_by", $data['usuario_id'], PDO::PARAM_INT);

        // Ejecutar la actualización
        $stmt->execute();

        // Registrar en el historial
        registerPropertyHistory($db, $data['id'], $data['usuario_id'], 'update');
